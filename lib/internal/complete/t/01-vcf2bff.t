...
# Define file names
my $output_file    = "t/genomicVariationsVcf-dev.json.gz";
my $reference_file = "t/expected_genomicVariationsVcf-dev.json.gz";  # adjust if needed

# Remove any existing output file to ensure a clean test
unlink $output_file if -e $output_file;

# Build the command line
my $cmd = "perl vcf2bff.pl -i t/test_pathogenic.vcf.gz --genome hg19 -dataset-id foo -project-dir 123456789 -f json -out-dir t";
